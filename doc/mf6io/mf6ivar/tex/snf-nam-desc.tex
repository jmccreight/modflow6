...
\begin{description}
\item \texttt{list}---is name of the listing file to create for this SNF model.  If not specified, then the name of the list file will be the basename of the SNF model name file and the '.lst' extension.  For example, if the SNF name file is called ``my.model.nam'' then the list file will be called ``my.model.lst''.
